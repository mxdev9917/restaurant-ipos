...
const Navbar = () => {
    ...
    const toggleDropdownLang = () => {
        setIsDropdownOpenLang(!isDropdownOpenLang);
    };
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex  items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                    <div>
                        ...
                        <div className={`z-50 ${isDropdownOpenLang ? 'block' : 'hidden'} my-1 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu absolute`}>
                ...
                <div className={` items-center justify-between ${isDropdownOpen ? 'block' : 'hidden'} w-full md:flex md:w-auto md:order-1" id="navbar-language`}>
                    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <a href="#card" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
                        </li>
                        <li>
