...
function NavBar() {
    return (
        <Navbar fluid rounded className="flex justify-center   w-full">
            ...
            <nav className="bg-[#3a393a] md:w-5/5 lg:w-4/5 border-gray-200  w-screen  md:rounded-full rounded-none flex justify-between items-center mx-auto py-2 px-4">
                ...
                <Navbar.Collapse id="navbar-default" className=" bg-[#3a393a] border-t-[0.7px] md:border-none  hidden  text-sm text-white  flex-col   mr-0 md:mr-2  w-full justify-end right-0 top-14 absolute md:relative md:top-0 md:flex md:flex-row " aria-labelledby="dropdownLargeButton">
                    <li>
