                    ...
                    <div className="flex justify-between w-full h-fit items-end">
                        <div className="flex flex-col w-fit h-fit pb-2 pl-2">
                            <div className="flex text-gray-500 ">
                                <Link className="text-orange-500 text-xs md:text-sm" to={""}>ຈັດການຢູເຊີ້</Link>
                            </div>
                            <div className="flex">
                        ...
                        <form className="p-4 md:p-5">
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                <div className="col-span-2">
                                    <label htmlFor="name" className="block mb-2  font-medium text-gray-900 text-xs md:text-sm"> Name <span className="text-red-600"> *</span></label>
                                ...
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="user" className="block mb-2 text-xs md:text-sm font-medium text-gray-900 ">ຢູເຊີ້<span className="text-red-600"> *</span></label>
                                    <input type="text" id="user" name="user" placeholder="...." className="bg-gray-50 border border-gray-300 text-gray-900 text-xs md:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " />
                                </div>
                                <div className="col-span-2 sm:col-span-1 relative">
                                    <label htmlFor="category" className="block mb-2 text-xs md:text-sm font-medium text-gray-900 ">ລະຫັດຜ່ານ<span className="text-red-600"> *</span></label>
                                    <input type={passwordType ? "text" : "password"} id="user" name="user" placeholder="..." className="bg-gray-50 border border-gray-300 text-gray-900 text-xs md:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " />
                                    <button onClick={togglePasswordType} className="absolute bottom-2 right-3">
                                        {
                                            passwordType ?
                                ...
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="phone" className="block mb-2 text-xs md:text-sm font-medium text-gray-900 ">Phone<span className="text-red-600"> *</span></label>
                                    <input type="tel" id="phone" name="phone" placeholder="020xxxxxxxx" pattern="[0-9]{3}[0-9]{8}" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs md:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  " />
                                </div>
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="category" className="block mb-2 text-xs md:text-sm font-medium text-gray-900 ">Role<span className="text-red-600"> *</span></label>
                                ...
                                <label className="inline-flex items-center me-5 cursor-pointer">
                                    ...
                                    <span className="ms-3 text-sm font-medium text-gray-900 ">{isCheckedTitle}</span>
                                </label>
                                <div className="col-span-2">
