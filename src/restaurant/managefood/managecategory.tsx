...
function manageCategory() {
    ...
    function handleModel(evens) {
        ...
        if (evens == 'add') {
            console.log('if add');
            setTitleModel('ເພີ່ມປະເພດອາຫານ')
            setisCheckModel(!isCheckModel)
            setisEven(true)
        } else if (evens == 'edit') {
            setTitleModel('ແກ້ໄຂປະເພດອາຫານ')
            setisCheckModel(!isCheckModel)
            setisEven(false)
        } else {
            setisCheckModel(!isCheckModel)
                        ...
                        <div className="flex justify-between w-full h-fit items-end border-b-[1px] border-gray-400">
                            <div className="flex flex-col w-fit h-fit pb-4">
                                <div className="flex text-gray-500">
                                    ...
                                    <Link className="text-orange-500 " to={""}>ຈັດການປະເພດອາຫານ</Link>
                            ...
                            <div className=" pr-1 mb-6  md:pr-5 ">
                                <button onClick={() => handleModel('add')} className="bg-green-500 hover:bg-green-600 py-2 px-4 rounded-full text-white">ເພີ່ມ</button>
                            </div>
                        </div>
                            ...
                            <table className="w-full  text-left rtl:text-right text-gray-500 ">
                                <thead className="text-base text-gray-600  bg-gray-50 px-10">
                                    <tr className="flex justify-between ">
                                        ...
                                        <th scope="col" className=" mr-14 py-3">
                                            ຈຳນວນເມນູ
                                        </th>
                                        <th scope="col" className="px-6 py-3">
                                            ເມນູ
