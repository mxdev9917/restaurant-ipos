                        ...
                        <table className="w-full  text-left rtl:text-right text-gray-500 ">
                            <thead className="text-base text-gray-600  bg-gray-50 px-10">
                                <tr className="flex justify-between ">
                                    ...
                                    <th scope="col" className=" mr-14 py-3 text-xs md:text-sm">
                                        ຈຳນວນເມນູ
                                    </th>
                            ...
                            <form className="p-4 md:p-5">
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    <div className="col-span-2">
                                        <label htmlFor="name" className="block mb-2 text-xs md:text-sm font-medium text-gray-900 ">Food Name <span className="text-red-600"> *</span></label>
