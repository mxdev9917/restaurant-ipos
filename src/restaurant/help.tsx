                    ...
                    <div className="flex flex-col lg:flex-row gap-3 bg-[#0e3c50] px-7 py-10 rounded-2xl shadow-lg">
                        <div className=" w-auto lg:w-96 h-[450px] pt-5  text-white font-semibold ">
                            <div className="text-3xl  md:border-b-2 pb-3">
                                <p>Lest't talk</p>
                                <p>on something <span className="text-orange-500">Great</span></p>
                                <p>togetther</p>
                            </div>
                            <div className="mt-3"></div>
                            <p className="flex items-end my-1">
                                <svg className="w-8 h-8 text-orange-500  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="flex flex-col  pt-5">
                                <span className="pl-4 text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Lorem, ipsum dolor sit amet consectetur</span>
                        ...
                        <div>
                            ...
                            <form className="w-85 lg:w-96 h-fit bg-white p-8 rounded-2xl shadow-lg">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="name" className="block  text-sm font-medium text-gray-900 dark:text-white pl-2">ຊື່</label>
                                    <input type="name" id="name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-none block w-full p-2.5 " placeholder="..." required />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="emil" className="block  text-sm font-medium text-gray-900 dark:text-white pl-2">ອີເມລ</label>
                                    <input type="text" id="emil" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-none block w-full p-2.5 " placeholder="..." required />
                                </div>
                                
                                <div className="mb-3">
                                    <label htmlFor="subject" className="block  text-sm font-medium text-gray-900 dark:text-white pl-2">ຫົວຂໍ້</label>
                                    <input type="text" id="subject" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-none  block w-full p-2.5 " placeholder="..." required />
                                </div>

                                <div className="mb-3">
                                    <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white pl-2">ຂໍ້ຄວາມ</label>
                                    <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-orange-500 focus:border-none " placeholder="Leave a comment..."></textarea>
                                </div>
                                <button type="submit" className="text-white bg-orange-500 hover:bg-orange-600 focus:ring-2 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">ສົ່ງຂໍ້ຄວາມ</button>
                            </form>
                        </div>
                    </div>
