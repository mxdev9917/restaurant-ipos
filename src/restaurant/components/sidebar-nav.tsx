            ...
            <aside id="separator-sidebar" className="fixed  top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-5 overflow-y-auto bg-gray-50 ">
                    <ul className="space-y-3 font-medium">
                        ...
                        <li>
                            ...
                            <ul id="dropdown_report" className="hidden py-2 space-y-2">
                                <li>
                                    <a href="/salereport" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ຍອດຂາຍ</a>
                                </li>
                                {/* <li>
                        ...
                        <li>
                            ...
                            <ul id="dropdown_setting" className="hidden py-2 space-y-2">
                                <li>
                                    <a href="/settingbill" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ຕັ້ງຄ່າບີນ</a>
                                </li>
                                <li>
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 ">
                        ...
                        <li>
                            <a href="/manual" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100   group">
