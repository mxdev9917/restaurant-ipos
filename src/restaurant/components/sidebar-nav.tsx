            ...
            <aside id="separator-sidebar" className="fixed  top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 py-5 overflow-y-auto bg-gray-50 ">
                    <ul className="space-y-3 font-medium">
                        ...
                        <li>
                            <Link to="/manageuser" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                        ...
                        <li>
                            <Link to="/sale" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                        ...
                        <li>
                            ...
                            <ul id="dropdown_ran" className="hidden py-2 space-y-2">
                                <li>
                                    <Link to="/managefood" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ເມນູອາຫານ</Link>
                                </li>
                                <li>
                                    <Link to="/managecategory" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ປະເພດອາຫານ</Link>
                                </li>
                                <li>
                                    <Link to="/managezone" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ໂຊນຮ້ານ</Link>
                                </li>
                                <li>
                                    <Link to="/managetable" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ໂຕະອາຫານ</Link>
                                </li>
                            </ul>
                        </li>
                        {/* <li>
                        ...
                        <li>
                            ...
                            <ul id="dropdown_report" className="hidden py-2 space-y-2">
                                <li>
                                    <Link to="/salereport" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ຍອດຂາຍ</Link>
                                </li>
                                {/* <li>
                                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ປະເພດອາຫານ</Link>
                                </Link>
                                <li>
                                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ໂຊນຮ້ານ</Link>
                                </Link>
                                <li>
                                    <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ໂຕະອາຫານ</Link>
                                </Link> */}
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul id="dropdown_setting" className="hidden py-2 space-y-2">
                                <li>
                                    <Link to="settingbill" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100  ">ຕັ້ງຄ່າບີນ</Link>
                                </li>
                                <li>
                    ...
                    <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 ">
                        <li>
                            <Link to="/payment" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100   group">
                                <svg className="flex-shrink-0 w-5 h-5 text-orange-500 transition duration-75  group-hover:text-orange-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 20">
                        ...
                        <li>
                            <Link to="/manual" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100   group">
                        ...
                        <li>
                            <Link to="/help" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100   group">
