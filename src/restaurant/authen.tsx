    ...
    return (
        <div className="w-screen h-screen flex  justify-between bg-[url('/src/assets/images/svg/blob-scene-haikei.svg')] bg-cover">
            <div className="w-[60%] h-screen flex flex-col justify-center items-center">
                {/* <p className="text-white text-4xl font-bold">wellcom</p> */}
            ...
            <div className="w-[40%] h-screen flex  items-center justify-start ">
                <form className="flex flex-col w-[400px] h-[400px] bg-white  rounded-md shadow-2xl p-4">
                    <p className="text-4xl text-orange-500 font-semibold mt-5">Sign in</p>

                    <input type="email" className="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-2 mt-7  " placeholder="john.doe@company.com" required />
